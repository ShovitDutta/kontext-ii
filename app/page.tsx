  ...
  const features = [
    {
      ...
      description:
        "Transform complex tech news into engaging, easy-to-understand blog posts using advanced AI.",
    },
    {
      icon: <Zap className="w-8 h-8 text-purple-400" />,
      title: "Real-time Updates",
      description:
        "Stay ahead with the latest technology news from trusted sources, updated in real-time.",
    },
    {
      icon: <Shield className="w-8 h-8 text-green-400" />,
      title: "Personalized Experience",
      description:
        "Get personalized news recommendations based on your interests and reading history.",
    },
    {
      icon: <Globe className="w-8 h-8 text-yellow-400" />,
      title: "Multiple Formats",
      description:
        "Choose from short summaries, detailed analysis, or explained versions for any news.",
    },
  ];
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            >
              Transform complex technology news into engaging, personalized blog
              posts. Stay informed with AI-generated content tailored to your
              understanding level.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to stay informed about the latest technology
              trends
            </p>
          </motion.div>
