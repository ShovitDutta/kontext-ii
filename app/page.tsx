...
export default function LandingPage() {
    const features = [
        ...
        },
        {
            ...
            description: "Stay ahead with the latest technology news from trusted sources, updated in real-time.",
        },
        {
            icon: <Shield className="w-8 h-8 text-green-400" />,
            title: "Personalized Experience",
            description: "Get personalized news recommendations based on your interests and reading history.",
        },
        {
            icon: <Globe className="w-8 h-8 text-yellow-400" />,
            title: "Multiple Formats",
            description: "Choose from short summaries, detailed analysis, or explained versions for any news.",
        },
    ];
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-20">
                    <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center">
                        <motion.h1 className="text-5xl md:text-7xl font-bold mb-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                            <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">AI-Powered</span>
                            <br />
